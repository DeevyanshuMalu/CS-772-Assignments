...
def main():
    ...
    with open(out_file, 'w') as f_out:
        for i in tqdm(range(0, input_ids.shape[0], test_batch_size)):
            out = generate(model, input_ids[i:i + test_batch_size], attention_mask=attention_mask[i:i + test_batch_size], steps=num_unmask_steps, gen_length=gen_length, block_length=gen_length, temperature=0., cfg_scale=cfg_scale-1, remasking='low_confidence')
